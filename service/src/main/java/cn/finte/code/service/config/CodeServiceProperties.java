 ...
 * @Date: 2017/5/3
 */
@ConfigurationProperties(prefix = "codeService", ignoreUnknownFields = false)
public class CodeServiceProperties {
    ...
    public static class Swagger {
        ...
        private String title = "Code Service-test API";

        private String description = "Code Service-test documentation";
